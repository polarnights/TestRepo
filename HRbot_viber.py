...
AGE = (
    ('underaged', 'До 18 лет'),
    ('good', 'От 18 до 65 лет'),
    ('elderly', 'Старше 65 лет'),
)

CITIZENSHIP = (
    ('good', 'Россия / Беларусь'),
    ('sng', 'Армения / Казахстан / Киргизия / Украина'),
    ('other', 'Другое'),
)
...
careers_actions = ('yesno_act', 'citizenship_act', 'age_act')
